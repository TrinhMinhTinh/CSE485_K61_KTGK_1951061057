...
<body>
    ...
    <main>
    <div class="container">
        <h5 class="text-center text-primary mt-5"> Điểm Sinh Viên Đại Học Thủy Lợi</h5>
    <div>
        ...
        <table class="table">
            ...
            <tbody>
                <?php
                    $conn = mysqli_connect('localhost','root','','1951061057_dhtl');
                    if(!$conn){
                ...
                ?>
                            <tr>
                                <th scope="row"><?php echo $row['ma_mh']; ?></th>
                                <td><?php echo $row['tenmh']; ?></td>
                                <td><?php echo $row['sotinchi']; ?></td>
                                <td><?php echo $row['sotiet_th']; ?></td>
